...
;   4. VGA graphics, mode 13h - color bars prove the framebuffer
;      works, then draw_frame takes over for everything after
;   5. Keyboard: real Set-1 scancode decoding (press, release, the
;      0xE0 extended prefix) for the 4 arrow keys, in key_state
;   6. PIT timer, reprogrammed from ~18.2 Hz to PIT_HZ. tick_count
